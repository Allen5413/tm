 ...
 */
@Service("countSendOnceOrderTMService")
public class CountSendOnceOrderTMServiceImpl extends EntityServiceImpl implements CountSendOnceOrderTMService {

    @Resource
    private FindPageByWhereDAO countSendOnceOrderTMDAO;

    @Override
    @Transactional
    public PageInfo findPageByWhere(PageInfo pageInfo, Map<String, String> map, Map<String, Boolean> sortMap) throws Exception {
        pageInfo = countSendOnceOrderTMDAO.findPageByWhere(pageInfo, map, sortMap);
