 ...
 */
@Service("downStudentBookOrderTMForSpotPrintService")
public class DownStudentBookOrderTMForSpotPrintServiceImpl extends EntityServiceImpl implements DownStudentBookOrderTMForSpotPrintService {
    ...
    public String down(String spotCode, String semesterId, String state, String operateTime, String fileName) throws Exception {
        ...
        JSONObject result = findStudentBookOrderTMForSpotPrintService.findStudentBookOrderTMForSpotPrint(null, params, null);
    ...
    private String createExcel(JSONObject data, String title, String spotStr, String fileName)throws Exception{
        ...
        if(null != data && data.size() > 0){
            ...
            while (it.hasNext()){
                ...
                String nameCodeLevel = "姓名："+orderJSON.get("name")+"    学号："+orderJSON.get("code")+"    层次："+orderJSON.get("levelName");
