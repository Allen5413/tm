 ...
 */
@Service("downStudentBookOrderTMForStudentPrintService")
public class DownStudentBookOrderTMForStudentPrintServiceImpl extends EntityServiceImpl implements DownStudentBookOrderTMForStudentPrintService {
    ...
    public String down(long semesterId, int state, String operateTime, String spotCode, String fileName) throws Exception {
        ...
        JSONObject result = findStudentBookOrderTMForStudentPrintService.print(semesterId, state, 0, 0, operateTime, spotCode, null);
