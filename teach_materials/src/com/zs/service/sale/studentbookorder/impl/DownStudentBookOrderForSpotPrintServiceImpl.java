 ...
 */
@Service("downStudentBookOrderForSpotPrintService")
public class DownStudentBookOrderForSpotPrintServiceImpl extends EntityServiceImpl implements DownStudentBookOrderForSpotPrintService {
    ...
    public void down(String spotCode, String semesterId, String state, String operateTime, String fileName) throws Exception {
        ...
        this.createExcel(jsonArray, title, fileName);
    }


    private void createExcel(JSONArray data, String title, String fileName)throws Exception{
        ...
        ExcelTools.writeExcelFile(exo, columnWidthMap, fileName);
    }
}
