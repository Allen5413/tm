 ...
 */
@Service("countSendPlaceOrderTMService")
public class CountSendPlaceOrderTMServiceImpl extends EntityServiceImpl implements CountSendPlaceOrderTMService {

    @Resource
    private FindPageByWhereDAO countSendPlaceOrderTMDAO;

    @Override
    @Transactional
    public PageInfo findPageByWhere(PageInfo pageInfo, Map<String, String> map, Map<String, Boolean> sortMap) throws Exception {
        pageInfo = countSendPlaceOrderTMDAO.findPageByWhere(pageInfo, map, sortMap);
