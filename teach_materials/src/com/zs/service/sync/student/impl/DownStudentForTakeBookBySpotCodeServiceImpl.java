 ...
 */
@Service("downStudentForTakeBookBySpotCodeService")
public class DownStudentForTakeBookBySpotCodeServiceImpl extends EntityServiceImpl implements DownStudentForTakeBookBySpotCodeService {

    @Resource
    private FindListByWhereDAO findStudentForTakeBookBySpotCodeDAO;
    @Resource
    ...
    public String down(String spotCode, String fileName) throws Exception {
        ...
        params.put("state", StudentBookOrder.STATE_SEND+"");
        Map<String, Boolean> sortMap = new HashMap<String, Boolean>();
        sortMap.put("s.code", true);
        List<Object[]> studentList = findStudentForTakeBookBySpotCodeDAO.findListByWhere(params, sortMap);

        return this.createExcel(studentList, "缴费领书学生信息表", spot.getName(), fileName);
    }


    private String createExcel(List<Object[]> data, String title, String spotName, String fileName)throws Exception{
        ...
        if(null != data && data.size() > 0){
            ...
            ExcelCell runCell_15 = new ExcelCell(index,(byte)7, "消费金额",false,"",30);
            ...
            for(int i = 0; i < data.size(); i++){
                ...
                BigDecimal buy = new BigDecimal(objs[7].toString());
                totalBuy = totalBuy.add(buy).setScale(2, BigDecimal.ROUND_HALF_UP);
                ...
                ExcelCell runCell_14 = new ExcelCell(index,(byte)6, objs[6].toString(),false,"",9);
                ExcelCell runCell_16 = new ExcelCell(index,(byte)7, buy.setScale(2, BigDecimal.ROUND_HALF_UP).toString(),false,"",9);
            ...
            ExcelCell runCell_17 = new ExcelCell(index,(byte)6, "合计",false,"",9);
            ExcelCell runCell_18 = new ExcelCell(index,(byte)7, totalBuy.toString(),false,"", 9);
