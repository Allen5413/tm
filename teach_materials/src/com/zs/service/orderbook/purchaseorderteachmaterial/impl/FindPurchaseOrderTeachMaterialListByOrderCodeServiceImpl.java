 ...
 */
@Service("findPurchaseOrderTeachMaterialListByOrderCodeService")
public class FindPurchaseOrderTeachMaterialListByOrderCodeServiceImpl
        extends EntityServiceImpl implements FindPurchaseOrderTeachMaterialListByOrderCodeService{

    @Resource
    private FindListByWhereDAO findPurchaseOrderTeachMaterialListByOrderCodeDAO;
    ...
    public JSONArray getPurchaseOrderTeachMaterialListByOrderCode(String orderCode, Long semesterId) {
        ...
        List<Object[]> resultList = findPurchaseOrderTeachMaterialListByOrderCodeDAO.findListByWhere(params, null);
        if(null != resultList && 0 < resultList.size()){
            ...
            for(Object[] objs : resultList){
                ...
                purchaseOrderTeachMaterial.setOperateTime((Date) objs[12]);
                ...
                jsonObject.put("operator", objs[11]);
