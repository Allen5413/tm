...
import com.zs.dao.finance.spotexpense.SpotExpenseOthDAO;
 ...
 */
@Service
public class AddStudentExpensePayServiceImpl extends EntityServiceImpl<StudentExpensePay,StudentExpensePayDao> implements AddStudentExpensePayService{
    ...
    public void addStudentExpensePay(StudentExpensePay studentExpensePay, String userName, String loginName) throws Exception {
        if (null !=studentExpensePay){
            ...
            //写入入账记录
            studentExpensePayDao.save(studentExpensePay);
