...
public class OrderCodeTools {
    ...
    public static final String PURCHASE_ORDER_CODE_ONCE = "GSO";
    ...
    public static final String STUDENT_ORDER_CODE_ONCE_MANUAL = "FSMO";
     ...
     * @return
     */
    public static String createPurchaseOrderCodeOnce(int year, int quarter, int number){
        StringBuilder sb = new StringBuilder(PURCHASE_ORDER_CODE_ONCE);
        sb.append(assembleCode(year, quarter, number, FOUR_DIGIT));
        return sb.toString();
    }
     ...
     * @return
     */
    public static String createStudentOnceOrderCodeForManual(int year, int quarter, int number){
        StringBuilder sb = new StringBuilder(STUDENT_ORDER_CODE_ONCE_MANUAL);
        sb.append(assembleCode(year, quarter, number, SIX_DIGIT));
        return sb.toString();
    }
