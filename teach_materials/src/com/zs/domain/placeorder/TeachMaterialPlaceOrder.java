...
public class TeachMaterialPlaceOrder extends AbstractEntity{
	...
	public static final String STATE_DOING = "2";    	 //处理中
	public static final String STATE_SORTING = "3";      //分拣中
	public static final String STATE_PACK = "4";         //已打包
	public static final String STATE_SEND = "5";         //已发出
	public static final String STATE_SIGN = "6";         //已签收

	public static final int IS_SPEC_ALL_NOT = 0;    //否
	public static final int IS_SPEC_ALL_YES = 1;    //是
	...
	public int getIsSpecAll() {
		return isSpecAll;
	}

	public void setIsSpecAll(int isSpecAll) {
		this.isSpecAll = isSpecAll;
	}
}
