...
public class TeachMaterialRatio extends AbstractEntity {
    ...
    public String getOperateTimeStr() {
        return DateTools.getFormattedString(this.getOperateTime(), DateTools.longDatePattern);
    }

    @Transient
    public String getCreateTimeStr() {
        return DateTools.getFormattedString(this.getCreateTime(), DateTools.longDatePattern);
    }
}
