 ...
 */
@Controller
@RequestMapping(value = "/findOncePurchaseOrderPageByWhere")
public class FindOncePurchaseOrderPageByWhereController extends LoggerController {
    private static Logger log = Logger.getLogger(FindOncePurchaseOrderPageByWhereController.class);

    @Resource
    private FindOncePurchaseOrderPageByWhereService findOncePurchaseOrderPageByWhereService;
    @Resource
    ...
    public String find(@RequestParam(value="semesterId", required=false, defaultValue="") String semesterId,
        ...
        try{
            ...
            pageInfo = findOncePurchaseOrderPageByWhereService.findPageByWhere(pageInfo, params, null);
            ...
            return "onceOrder/oncePurchaseOrderList";
        }
        catch(Exception e){
