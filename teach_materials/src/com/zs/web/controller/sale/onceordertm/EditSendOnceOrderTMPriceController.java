 ...
 */
@Controller
@RequestMapping(value = "/editSendOnceOrderTMPrice")
public class EditSendOnceOrderTMPriceController extends LoggerController {
    private static Logger log = Logger.getLogger(EditSendOnceOrderTMPriceController.class);

    @Resource
    private EditSendOnceOrderTMPriceService editSendOnceOrderTMPriceService;
    @Resource
    ...
    public String open(){
        return "onceOrder/editSendOnceOrderTMPrice";
    }
    ...
    public JSONObject editor(@RequestParam(value="semesterId") String semesterId,
        ...
        try{
            ...
            editSendOnceOrderTMPriceService.editor(params, sortMap, UserTools.getLoginUserForName(request));
