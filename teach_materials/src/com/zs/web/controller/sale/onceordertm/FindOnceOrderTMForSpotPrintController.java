 ...
 */
@Controller
@RequestMapping(value = "/findOnceOrderTMForSpotPrint")
public class FindOnceOrderTMForSpotPrintController extends LoggerController {
    private static Logger log = Logger.getLogger(FindOnceOrderTMForSpotPrintController.class);

    @Resource
    private FindOnceOrderTMForSpotPrintService findOnceOrderTMForSpotPrintService;
    @Resource
    ...
    public String find(@RequestParam(value="semesterId") String semesterId,
        ...
        try{
            ...
            JSONObject result = findOnceOrderTMForSpotPrintService.find("0".equals(flag) ? null : request, params, null);
            request.setAttribute("resultJson", result);
            request.setAttribute("spot", spot);
            request.setAttribute("semester", semester);
            return "onceOrder/spotOrderTMPrintList";
        }
        catch(Exception e){
