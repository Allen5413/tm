 ...
 */
@Controller
@RequestMapping(value = "/findStudentBookOrderForSpotCount")
public class FindStudentBookOrderForSpotCountController extends LoggerController {
    ...
    @Resource
    private FindStudentBookOrderPageByWhereService findStudentBookOrderForSpotCountService;
    @Resource
    ...
    public String find(@RequestParam(value="semesterId", required=false, defaultValue="") String semesterId,
        ...
        try{
            ...
            params.put("isSendStudent", StudentBookOrder.IS_SEND_STUDENT_NOT+"");
            ...
            pageInfo = findStudentBookOrderForSpotCountService.findPageByWhere(pageInfo, params, sortMap);

            request.setAttribute("semesterId", semesterId);
            request.setAttribute("semesterList", semesterList);
            request.setAttribute("spotList", spotList);
            request.setAttribute("pageInfo", pageInfo);
            return "studentOrder/spotCountOrderList";
        }
        catch(Exception e){
