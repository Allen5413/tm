 ...
 */
@Controller
@RequestMapping(value = "/countSendStudentBookOrderByTMId")
public class CountSendStudentBookOrderByTMIdController extends LoggerController {
    ...
    public String find(@RequestParam(value="semesterId") String semesterId,
        ...
        try{
            ...
            JSONArray jsonArray = countSendStudentBookOrderByTMIdService.countSendStudentBookOrderByTMId(params, sortMap);

            request.setAttribute("jsonArray", jsonArray);
            request.setAttribute("teachMaterial", teachMaterial);
            return "studentOrder/countSendStudentBookOrderByTMIdList";
        }
        catch(Exception e){
