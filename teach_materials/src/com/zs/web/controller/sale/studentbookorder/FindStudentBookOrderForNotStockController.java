 ...
 */
@Controller
@RequestMapping(value = "/findStudentBookOrderForNotStock")
public class FindStudentBookOrderForNotStockController extends LoggerController {
    ...
    public String purchaseOrderListSearch(@RequestParam(value="semesterId") String semesterId,
    ...
    private String setSearchData(HttpServletRequest request, String provCode, String spotCode){
        ...
        return returnPath+"studentOrder/studentOrderForNotStockList";
    }
}
