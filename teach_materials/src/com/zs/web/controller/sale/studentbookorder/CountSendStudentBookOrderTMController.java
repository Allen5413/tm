 ...
 */
@Controller
@RequestMapping(value = "/countSendStudentBookOrderTM")
public class CountSendStudentBookOrderTMController extends LoggerController{
        private static Logger log = Logger.getLogger(CountSendStudentBookOrderTMController.class);

        @Resource
        private FindSemesterPageByWhereService findSemesterPageByWhereService;
        @Resource
        private CountSendStudentBookOrderTMService countSendStudentBookOrderTMService;
        ...
        public String open(HttpServletRequest request) {
            ...
            return "studentOrder/countSendStudentBookOrderTMList";
        }
        ...
        try{
            ...
            pageInfo = countSendStudentBookOrderTMService.findPageByWhere(pageInfo, params, null);
