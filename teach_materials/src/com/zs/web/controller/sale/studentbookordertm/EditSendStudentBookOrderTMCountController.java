 ...
 */
@Controller
@RequestMapping(value = "/editSendStudentBookOrderTMCount")
public class EditSendStudentBookOrderTMCountController extends LoggerController {
    private static Logger log = Logger.getLogger(EditSendStudentBookOrderTMCountController.class);

    @Resource
    private EditSendStudentBookOrderTMCountService editSendStudentBookOrderTMCountService;
    @Resource
    ...
    public String open(){
        return "studentOrder/editSendStudentBookOrderTMCount";
    }
    ...
    public JSONObject editor(@RequestParam(value="semesterId") String semesterId,
        ...
        try{
            ...
            editSendStudentBookOrderTMCountService.editSendStudentBookOrderTMCount(params, sortMap, UserTools.getLoginUserForName(request));
