 ...
 */
@Controller
@RequestMapping(value = "/addStudentBookOrderPackageForStudent")
public class AddStudentBookOrderPackageForStudentController extends
        LoggerController<StudentBookOrderPackage, AddStudentBookOrderPackageService> {

    private static Logger log = Logger.getLogger(AddStudentBookOrderPackageForStudentController.class);
    ...
    public String open(HttpServletRequest request){
        return "studentOrder/studentOrderPackageAddForStudent";
    }
    ...
    public JSONObject add(HttpServletRequest request,
        ...
        try{
            ...
            addStudentBookOrderPackageService.addStudentBookOrderPackage(student.getSpotCode(), orderCode, logisticCode, StudentBookOrderPackage.IS_ONCE_NOT, UserTools.getLoginUserForName(request));
