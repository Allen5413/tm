 ...
 */
@Controller
@RequestMapping(value = "/findOnceOrderPackagePageByWhere")
public class FindOnceOrderPackagePageByWhereController extends LoggerController {
    private static Logger log = Logger.getLogger(FindOnceOrderPackagePageByWhereController.class);
    ...
    private String setSearchData(HttpServletRequest request, String provCode){
        ...
        return returnPath+"onceOrder/onceOrderPackageList";
    }
}
