 ...
 */
@Controller
@RequestMapping(value = "/findStuEPPageByWhere")
public class FindStuEPPageByWhereController  extends LoggerController {
    private static Logger log = Logger.getLogger(FindStuEPPageByWhereController.class);
    ...
    public String find(@RequestParam(value="spotCode", required=false, defaultValue="") String spotCode,
        ...
        try {
            if("search".equals(method)) {
                ...
                JSONObject returnJSON = findStuEPPageByWhereService.findPage(pageInfo, params, null);
                if(null != returnJSON) {
    ...
    private String setSearchData(HttpServletRequest request, String spotCode){
        ...
        return returnPath+"finance/stuEPList";
    }
}
