 ...
 */
@Controller
@RequestMapping(value = "/findPlaceOrderForNotStock")
public class FindPlaceOrderForNotStockController extends LoggerController {
    private static Logger log = Logger.getLogger(FindPlaceOrderForNotStockController.class);
    ...
    private String setSearchData(HttpServletRequest request, String provCode){
        ...
        return returnPath+"placeOrder/placeOrderForNotStockList";
    }
}
