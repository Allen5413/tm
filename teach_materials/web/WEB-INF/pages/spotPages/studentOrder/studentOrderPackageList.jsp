...
<%--<div class="main-content">--%>
  <%--<form id="pageForm" name="pageForm" action="${pageContext.request.contextPath}/findStudentBookOrderPackagePageByWhere/find.htm" method="post">--%>
...
<%--<script>--%>
  <%--$(function(){--%>
    <%--if($("#provCode").val() != ""){--%>
      <%--selectProv();--%>
      <%--$("#spotCode").val("${param.spotCode}");--%>
    <%--}--%>
  <%--});--%>

  <%--function searchOrder(id){--%>
    <%--parent.openDialog('教材包的学生发书单', 0.8, 0.8, '${pageContext.request.contextPath}/findStudentBookOrderByPackageId/find.htm?packageId='+id);--%>
  <%--}--%>
      ...
      <tr>
        ...
        <td>
          <div class="am-btn-group">
            <button type="button" class="am-btn am-btn-primary am-round" onClick="printPackage(${json.id})"><span class="am-icon-th-list"></span> 查看</button>
          </div>
        </td>
      </tr>
    </c:forEach>
...
<script>
  ...
  function searchOrder(id){
    app.openOneBtnDialog('${pageContext.request.contextPath}/findStudentBookOrderByPackageId/find.htm?packageId='+id, '教材包的学生发书单', 1400, 0.8);
  }
</script>