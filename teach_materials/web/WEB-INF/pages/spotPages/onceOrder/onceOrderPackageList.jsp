...
<%--<script>--%>
  ...
  <%--function searchOrder(id){--%>
    <%--parent.openDialog('教材包的学生发书单', 0.8, 0.8, '${pageContext.request.contextPath}/findOnceOrderByPackageId/find.htm?packageId='+id);--%>
  <%--}--%>
  ...
  <%--function editLogisticCode(id){--%>
    ...
    <%--dialog.URL = "${pageContext.request.contextPath}/editStudentBookOrderPackageForLogisticCode/open.htm?id="+id;--%>
    <%--dialog.show();--%>
