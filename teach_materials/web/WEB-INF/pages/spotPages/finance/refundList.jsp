...
<%--<script>--%>
  <%--function add(){--%>
    ...
    <%--dialog.Title = "缴费";--%>
    <%--dialog.URL = "${pageContext.request.contextPath}/addRefund/open.htm?spotCode=${spot.code}";--%>
    <%--dialog.show();--%>
...
<script>
  ...
  function add(){
    app.openDialog("${pageContext.request.contextPath}/addRefund/open.htm?spotCode=${spot.code}", '申请退款', 1200, 0.7, function(index){
      var isSub = false;
      var msg = "";
