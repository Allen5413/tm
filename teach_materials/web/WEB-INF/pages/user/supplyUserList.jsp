...
<script>
  function add(){
    parent.openDialog('新增教材管理员用户', 500, 400, '${pageContext.request.contextPath}/addUser/openAddUserPage.htm');
  }

  function edit(id){
    parent.openDialog('编辑教材管理员用户', 500, 400, '${pageContext.request.contextPath}/editUser/openEditUserPage.htm?id='+id);
  }
