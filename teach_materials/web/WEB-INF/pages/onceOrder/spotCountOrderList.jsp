...
<%--<div class="main-content">--%>
  <%--<form id="pageForm" name="pageForm" action="${pageContext.request.contextPath}/findOnceOrderForSpotCount/find.htm" method="post">--%>
...
<%--<script>--%>
  <%--function printTMOrder(code, operateTime, flag){--%>
    ...
    <%--open("${pageContext.request.contextPath}/findOnceOrderTMForSpotPrint/find.htm?spotCode="+code+"&semesterId="+semesterId+"&state="+state+"&operateTime="+operateTime+"&flag="+flag);--%>
  <%--}--%>
<%--</script>--%>
...
<script>
  ...
  function printTMOrder(code, operateTime, flag){
    ...
    var state = '${param.state}';
    <c:if test="${empty param.state}">state = 2;</c:if>
    open("${pageContext.request.contextPath}/findOnceOrderTMForSpotPrint/find.htm?spotCode="+code+"&semesterId="+semesterId+"&state="+state+"&flag="+flag+"&operateTime="+operateTime);
    if(1 == flag) {
      setTimeout(function () {
        $("#state").val("3");
        $("#searchBtn").click();
