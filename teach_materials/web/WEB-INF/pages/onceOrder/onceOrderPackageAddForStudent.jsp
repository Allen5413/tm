...
<form id="addForm" name="addForm" target="_blank" action="${pageContext.request.contextPath}/addOnceOrderPackageForStudent/add.htm" method="post">
  <label >快递单号：</label>
...
<script>
  ...
  function addPackage(){
    ...
    $.ajax({
      cache: true,
      type: "POST",
      url:"${pageContext.request.contextPath}/addOnceOrderPackageForStudent/add.htm",
