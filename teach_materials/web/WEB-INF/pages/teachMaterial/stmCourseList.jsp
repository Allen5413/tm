...
<%--<div id="div" class="main-content" style="overflow-y:scroll; height: 200px;">--%>
  <%--<table  id="stmCourseTable" class="table_slist" cellpadding="0" cellspacing="0" width="100%">--%>
    <%--<tr>--%>
      <%--<th style="width: 20px;"></th>--%>
      <%--<th style="width: 80px;">课程编号</th>--%>
      <%--<th style="width: 150px;">课程名称</th>--%>
    <%--</tr>--%>
    <%--<c:if test="${!empty stmCourseList}">--%>
      <%--<c:forEach var="course" items="${stmCourseList}" varStatus="status">--%>
        <%--<tr>--%>
          <%--<td align="center">--%>
            <%--<c:if test="${param.buyCourseCode ne course.code}">--%>
...
<%--<script>--%>
  ...
  <%--function sub(){--%>
    <%--$.ajax({--%>
      <%--cache: true,--%>
      <%--type: "POST",--%>
      <%--url:"/addSTMCourse/stmCourseAdd.htm",--%>
      <%--data:{--%>
        <%--"stmId":${param.stmId},--%>
...
<div class="am-panel am-panel-primary" style="width:99%; margin-left:4px;">
  ...
  <div id="course" class="am-in">
    <table id="stmCourseTable" class="am-table am-table-bordered am-table-striped am-table-hover" style="width:100%;">
      <tr class="am-primary">
