      ...
      <%--<table class="table_slist" cellpadding="0" cellspacing="0" width="100%">--%>
        ...
        <%--<c:forEach var="json" items="${pageInfo.pageResults}" varStatus="status">--%>
          <%--<tr>--%>
            ...
            <%--</td>--%>
            <%--<td>--%>
              <%--<a href="#" onclick="printPackage(${json.id})" style="color: #0092DC">打印</a>&nbsp;&nbsp;--%>
              <%--<c:if test="${json.isSign == 1}">--%>
                <%--<a href="#" onclick="editLogisticCode(${json.id})" style="color: #0092DC">修改物流单号</a>--%>
              <%--</c:if>--%>
            <%--</td>--%>
          <%--</tr>--%>
        <%--</c:forEach>--%>
...
<%--<script>--%>
  ...
  <%--function editLogisticCode(id){--%>
    ...
    <%--dialog.Title = "修改物流单号";--%>
    <%--dialog.MessageTitle = "<font style=\"color:red\">修改物流单号注意事项</font>";--%>
    <%--dialog.Message = "<font style=\"color:red\">物流单号一定要准确无误，多个物流单号用\",\"英文逗号隔开</font>";--%>
    <%--dialog.URL = "${pageContext.request.contextPath}/editPlaceOrderPackageForLogisticCode/open.htm?id="+id;--%>
    <%--dialog.show();--%>
...
<script>
  ...
  function editLogisticCode(id){
    var url = '${pageContext.request.contextPath}/editPlaceOrderPackageForLogisticCode/open.htm?id='+id;
    app.openDialog(url, '修改物流单号', 500, 0.4, function(index){
      ...
      app.edit("${pageContext.request.contextPath}/editPlaceOrderPackageForLogisticCode/editor.htm", $('#editForm').serialize(), index);
    });
  }
