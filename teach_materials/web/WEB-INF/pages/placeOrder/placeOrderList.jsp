...
<%--<script>--%>
  ...
  <%--function addTM(){--%>
    ...
    <%--dialog.Height = 800;--%>
    <%--dialog.Title = "添加教材";--%>
    <%--dialog.URL = '${pageContext.request.contextPath}/addPlaceOrderTM/open.htm?spotCode='+spotCode;--%>
    <%--dialog.show();--%>
  <%--}--%>
  ...
  <%--function resetForm(){--%>
    <%--$("#enterYear, #quarter, #spotCode, #specCode, #levelCode, #state").val('');--%>
    <%--<c:forEach var="semester" items="${semesterList}">--%>
...
<script>
  ...
  function addTM(){
    ...
    var url = '${pageContext.request.contextPath}/addPlaceOrderTM/open.htm?spotCode='+spotCode;
