  ...
  <div id="num_${status.index}" class="print_content">
    ...
    <div class="print_table">
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="4">
            <c:if test="${result.value.isSendStudent eq '0'}">
              发中心
            </c:if>
            <c:if test="${result.value.isSendStudent eq '1'}">
              发学生&nbsp;&nbsp;${result.value.sendAddress}&nbsp;&nbsp;${result.value.sendPhone}&nbsp;&nbsp;${result.value.sendZipCode}
            </c:if>
          </td>
