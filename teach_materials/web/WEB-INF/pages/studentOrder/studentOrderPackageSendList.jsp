...
<%--<div class="main-content">--%>
  <%--<form id="pageForm" name="pageForm" action="${pageContext.request.contextPath}/findStudentBookOrderPackageForSpotCountPage/find.htm" method="post">--%>
...
<%--<script>--%>
  <%--function send(spotCode){--%>
    ...
    <%--parent.openDialog('填写物流单号', 0.3, 0.6, '${pageContext.request.contextPath}/sendStudentBookOrderPackage/open.htm?spotCode='+spotCode+'&semesterId='+semesterId);--%>
  <%--}--%>
...
<script>
  ...
  function send(spotCode){
    var semesterId = $("#semesterId").val();
    app.openDialog('${pageContext.request.contextPath}/sendStudentBookOrderPackage/open.htm?spotCode='+spotCode+'&semesterId='+semesterId, '填写物流单号', 0.3, 0.6, function(index){
      var isValid = true;
      ...
      app.add("${pageContext.request.contextPath}/sendStudentBookOrderPackage/send.htm", $('#addForm').serialize(), index);
    });
  }
</script>